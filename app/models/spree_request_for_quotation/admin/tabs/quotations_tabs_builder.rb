    ...
    module Tabs
      class QuotationsTabsBuilder
        ...
        def add_details_tab(root)
          tab = ::Spree::Admin::Tabs::TabBuilder.new('details', ->(resource) { edit_admin_variant_quotation_request_path(resource) }).
        ...
        def add_translations_tab(root)
          tab = ::Spree::Admin::Tabs::TabBuilder.new('translations', ->(resource) { translations_admin_variant_quotation_path(resource) }).
